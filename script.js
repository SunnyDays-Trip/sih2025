...
const translations = {
    ...
    hi: {
        ...
        //weather tools
        "location-input": "अपना स्थान दर्ज करें",
        "search-btn": "मौसम प्राप्त करें",
    ...
    pa: {
        ...
        //weather tools
        "location-input": "ਆਪਣਾ ਟਿਕਾਣਾ ਦਾਖਲ ਕਰੋ",
        "search-btn": "ਮੌਸਮ ਪ੍ਰਾਪਤ ਕਰੋ",
...
async function updateWeatherData() {
    ...
    try {
        ...
        document.getElementById('weather-wind').textContent = `🍃 : ${windKmh}`;
        document.getElementById('weather-humidity').textContent = `💧: ${humidity}`;
        document.getElementById('weather-pressure').textContent = `🗜 : ${pressure}`;
        ...
        const keywords = ["overcast clouds", "drizzle", "thunderstorm","घनघोर बादल"];
        ...
        if (rainAlertEl) {
            if (keywords.some(word => weatherMain.includes(word) || weatherDesc.includes(word))) {
                ...
                rainAlertEl.textContent = "⚠️ Rain Alert! Rain is expected in your area soon.";
            } else {
